              ...
              >
                ...
                <div className="relative">
                  <div className="flex flex-row-reverse items-center justify-between">
                    ...
                    <div>
                      <h3 className="font-playfair capitalize text-[16px] sm:text-xl">
                        {job.position.toLocaleLowerCase()}
                      </h3>
                      <p className="font-palanquin capitalize text-sm">
                        {job.company.toLocaleLowerCase()}
                      </p>
                    </div>
                  </div>
