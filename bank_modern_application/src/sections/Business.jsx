...
const FeatureCard = ({icon, title, content}) =>  (
    <div className={`flex flex-row p-6 rounded-[20px] gap-6
    feature-card`}>
      ...
      <div className="flex-1 flex flex-col ml-4">
          <h4 className="font-poppins font-semibold
           text-white text-[18px] leading-[20px] mb-2">
            {title}
          </h4>
          <p className="font-poppins font-semibold
           text-dimWhite text-[16px] leading-[20px] mb-2 max-w-[440px]">
            {content}
          </p>
      </div>
    </div>
  ...
  return (
    <section id="features" className={`${layout.section}`}>
      ...
      <div className={layout.sectionInfo}>
          ...
          <Button styles="mt-10 rounded-[10px]" btnText="Get started"/>
      </div>
